    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShareOrders", x => x.Id);
                });
            ...
            migrationBuilder.Sql("Insert Into Shares Values (NEWID(), 'Test1')");
            migrationBuilder.Sql("Insert Into Shares Values (NEWID(), 'Test2')");            
        }
